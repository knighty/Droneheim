...
namespace Droneheim.GUI
{
	...
	{
		protected KeyframeList keyframes;
		...
		public KeyframeGraphLineEnumerator(KeyframeList keyframes, int from, int to, int resolution = 1)
		{
	...
	class KeyframeGraphLine : GraphData
	{
		...
		public float MinValue => keyframes.GetMinimumMagnitude();

		public float MaxValue => keyframes.GetMaximumMagnitude();

		public int NumPoints => keyframes.Count;

		public bool Visible => true;

		public KeyframeGraphLine(KeyframeList keyframes)
		{
			this.keyframes = keyframes;
		}
